...
class MipNerf(nn.Module):
    ...
    def forward(self, rays: namedtuple, randomized: bool, white_bkgd: bool = True):
        """The mip-NeRF Model.
        Args:
            rays: util.Rays, a namedtuple of ray origins, directions, and viewdirs.
            randomized: bool, use randomized stratified sampling. Train=True & Val=False
